...
@pytest.mark.performance
@pytest.mark.parametrize(Task3_1.variables, Task3_1.amounts)
def test_task3_1_performance_with_index(database: Database, apply_task3_migrations, factories: TypeFactories):
    """
    ...
    base_test_3_1(database=database, factories=factories, amount_of_posts=50000)
    breakpoint()
